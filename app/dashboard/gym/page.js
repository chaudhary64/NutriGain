          ...
          <div className="flex flex-col sm:flex-row justify-between items-center py-3 sm:py-0 sm:h-16 gap-3 sm:gap-4">
            ...
            <div className="hidden sm:flex sm:flex-row items-center gap-2 sm:gap-3">
              <button
                ...
                className="px-4 py-2 text-gray-700 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition font-medium text-sm flex items-center gap-1"
              >
                🍽️ Meal
              </button>
              ...
              <button
                ...
                className="px-4 py-2 text-green-600 bg-green-50 rounded-lg font-medium text-sm flex items-center gap-1"
              >
                💪 Gym
              </button>
